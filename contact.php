...
<div class="video-container">
  ...
  <div class="image-container">
      <div>
        <img src="June (Facebook Post) (2).png" alt="Image 1">
        <p class="us2">Stick.it_up.contact@gmail.com</p>
        <br><br><br><br><br>
      </div>
      <div>
        <img src="June (Facebook Post).png"alt="Image 2">
        <a href="https://www.facebook.com/oumayma.hammami.9026?locale=fr_FR" class="link"><p class="us2">Stick.it_up</p></a>
        <br><br><br><br><br><br><br><br><br><br>
      </div>
      <div>
        <img src="June (Facebook Post) (1).png" alt="Image 3">
        <a href="https://www.instagram.com/stick.it_up/" class="link"><p class="us2">Stick.it_up</p></a>
        <br><br><br><br><br><br><br><br><br><br>
      </div>
...
<div>
  <br>
  <span style="display: inline-block; width: 30%;margin-right: 20px;margin-left: 50px;text-align: center; font-size: 17px;"><a onclick="scrollToTop();">Contact</a></span>
</div>
<br><br><br>
<hr>
